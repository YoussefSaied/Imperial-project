...
vector<Dalle> Brique:: dalle6() const
{
    ...
    //2
    d6.push_back(Dalle((get_position()-hauteur*get_vecteur_1()) , get_vecteur_1()
                       , get_vecteur_2(),get_longueur(), get_largeur()));
    //3
    d6.push_back(Dalle((get_position()) , -1*get_vecteur_2()
                       , get_vecteur_3(),get_largeur(), hauteur));

    //4
    d6.push_back(Dalle((get_position()) , -1*get_vecteur_3()
                       , -1* get_vecteur_1(),hauteur, get_longueur()));

    //5
    d6.push_back(Dalle((get_position() + get_longueur()*get_vecteur_2()) , get_vecteur_2()
                       , -1*get_vecteur_1(),hauteur, get_largeur()));

    //6
    d6.push_back(Dalle((get_position() + get_largeur()*get_vecteur_3()) , get_vecteur_3()
...
{
    Vecteur3D x0(dalle.PointPlusProche(x_i));
