...
public:
	...
	Plan(Position position, Vecteur3D vector1, bool m= false): Obstacle(position,m) { vecteur_1 = vector1.normalise(); }
    virtual ~Plan() {}
    ...
    void distancea(Vecteur3D vector1)const; //affiche le point le plus proche au vector11;
