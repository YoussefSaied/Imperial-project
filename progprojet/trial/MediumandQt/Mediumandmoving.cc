...
int main(int argc, char* argv[])
{
    ...
    Sphere sphere_obstacle(Position(5.0, 0.0, 4.0), 1.0, true);
    Mediumi brique_obstacle(dalle_obstacled, 5.0);
    //Brique brique_obstacle(dalle_obstacled, 5.0);
    Source source(Position(0.5,0,7), grainLJUn2, Vitesse(100,200,500), 50.2, 0.25, 30.27, true );
    Source source2(Position(5.5,0,7), grainLJDeux1, Vitesse(), 5.2, 0.25, 30.27, true );
